        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemOrderedPlantItemId = table.Column<int>(name: "ItemOrdered_PlantItemId", type: "int", nullable: true),
                    ItemOrderedPlantName = table.Column<string>(name: "ItemOrdered_PlantName", type: "nvarchar(max)", nullable: true),
